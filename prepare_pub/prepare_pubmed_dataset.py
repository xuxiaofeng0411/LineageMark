...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Prepare a 35k PubMed abstract subset for causal LM full fine-tuning."
    )
    ...
    parser.add_argument("--min_abstract_chars", type=int, default=100)
    parser.add_argument("--seed", type=int, default=42)
    parser.add_argument("--num_proc", type=int, default=1)
    parser.add_argument(
        "--include_pmid",
        action="store_true",
        help="Include PubMed ID in the training text. By default only the abstract is used.",
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
