...
DATA_PATH = "/root/autodl-tmp/datasets/processed_biology_25k"
WATERMARKED_MODEL_PATH = "/root/autodl-tmp/models/facebook/opt-1.3b-inserted-by-dssa2"
FINETUNED_OUTPUT_DIR = "/root/autodl-tmp/models/opt-1.3b-inserted-by-dssa-finetuned-biology2"
...
def load_and_prepare_data(data_path="/root/autodl-tmp/datasets/processed_biology_25k"):
    print("=" * 60)
    print("加载处理好的数据集...")
    print("=" * 60)
...
def get_model_and_tokenizer(model_path="/root/autodl-tmp/models/facebook/opt-1.3b-inserted-by-dssa2"):
    print("\n" + "=" * 60)
    print("加载模型和分词器...")
    print("=" * 60)
...
def finetune_model(
    ...
    train_dataset,
    val_dataset,
    output_dir="/root/autodl-tmp/models/opt-1.3b-inserted-by-dssa-finetuned-biology4",
    num_epochs=3,
    batch_size=16,
...
def main():
    ...
    if torch.cuda.is_available():
        ...
        raise RuntimeError("GPU不可用，不建议用 CPU 训练 OPT-1.3B")
